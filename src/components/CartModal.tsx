...
import {
  ...
  Leaf,
  Droplet,
} from "lucide-react"; // Use Droplet instead of Water
        ...
        <div className="h-20 px-4 md:px-10 lg:px-20 xl:px-32 2xl:px-64 flex items-center justify-between">
          ...
          <div className="flex items-center justify-between w-full md:hidden">
            <Link href="/" className="flex items-center gap-2 text-text">
              <ShoppingBag size={28} className="text-text" />
          ...
          <div className="hidden md:flex items-center justify-between w-full">
            <div className="flex items-center gap-10">
              ...
              <nav className="hidden xl:flex gap-6 text-text font-medium">
                <Link
                  href="/"
                  className="flex items-center gap-2 hover:text-heading transition-colors duration-200"
                >
                ...
                <Link
                  ...
                  className="flex items-center gap-2 hover:text-heading transition-colors duration-200"
                >
                  <Phone size={18} className="text-text" />
                  Contact
                </Link>
              </nav>
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                {theme === "autumn" && <Leaf size={24} />}
                {theme === "calm" && <Droplet size={24} />}{" "}
                {/* Droplet icon for calm */}
              </button>
            </div>
          </div>
        </div>
