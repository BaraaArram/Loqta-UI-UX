        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <section className="bg-cardC rounded-xl shadow p-6">
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-3xl font-extrabold text-heading">{t('categories')}</h1>
              <button
            ...
            {categoriesLoading ? (
              ...
              <NoData message={t('no_categories_found')} />
            ) : (
        ...
        {editCategory && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-cardC rounded-xl shadow-lg p-8 w-full max-w-md relative">
              ...
              <h2 className="text-xl font-bold mb-4 text-heading">{t('edit_category')}</h2>
