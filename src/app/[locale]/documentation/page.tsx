// Loqta Documentation Page
// Renders project documentation using Markdown with custom styles and sidebar navigation.
"use client";
...
const documentation = [
  ...
  '',
  '## Introduction',
  'Loqta UI/UX is a modern, themeable e-commerce frontend built with Next.js, React, Redux Toolkit, Axios, and Tailwind CSS. It features robust authentication, a dynamic cart system, internationalization (i18n), multiple unique themes (including a "Vintage" theme for used items), and a fully accessible UI. This documentation covers architecture, best practices, and code examples for developers.',
  '',
  '---',
  '',
  '## Tech Stack',
...
'- Use `t(\'key\')` from `react-i18next` for all UI strings.',
  ...
  '',
  '- Multiple themes: Light, Dark, Autumn, Calm, Bazaar, and Vintage (used/old look).',
  '- The "Vintage" theme features aged paper backgrounds, retro fonts, sepia images, and distressed UI for a second-hand marketplace feel.',
  '- Theme is persisted in localStorage and restored on refresh.',
  '- Theme switcher is fully i18n-aware and accessible.',
  '',
  '### Adding a New Theme',
  '1. Add a new `[data-theme="yourtheme"]` block in `src/styles/globals.css` with custom CSS variables.',
  '2. Add the theme to the `ThemeSwitcher` options in `src/components/ThemeSwitcher.tsx`.',
  '3. Add translation keys for the theme name and description.',
  '',
  '---',
  '',
  '## Project Structure',
  ...
  '## UI/UX & Accessibility',
  '',
  '- All components use semantic, theme-aware Tailwind classes.',
  '- Accessibility: keyboard navigation, focus rings, ARIA labels, color contrast.',
  '- Responsive design for all devices.',
  '- Enhanced modals, forms, and feedback with SweetAlert2 (now fully i18n-aware).',
  '',
  '---',
  '',
  '## Removed Features',
  '',
  '- The real-time chat feature has been removed for a more focused product, cart, and order experience.',
  '',
  '---',
  '',
  '## Error Handling',
